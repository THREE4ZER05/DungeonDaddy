...
class KeyLevelSelectMenu(Select):
    def __init__(self):
        ...
        for level in KEY_LEVELS:
            if level == "separator":
                # Use a unique value for the separator option.
                options.append(discord.SelectOption(label="──────────", value="separator_value", disabled=True))
            else:
                options.append(discord.SelectOption(label=level, value=level))
